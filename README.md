...
People自身は最終的な住所録になることを目指していません。溜まったデータは、タグやグループで絞り込み、vCard (.vcf) や 各種CSV（Google連絡先、Outlook対応）形式で一括エクスポートが可能です。出力されたファイルをダブルクリックしたり読み込ませるだけで、AppleやGoogle、Microsoftの標準連絡先にクリーンなデータが統合されます。
